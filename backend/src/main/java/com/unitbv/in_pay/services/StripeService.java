    ...
    public StripeResponse payInvoice(Integer userId, InvoiceRequest invoiceRequest) {
        ...
        SessionCreateParams params =
                SessionCreateParams.builder()
                        ...
                        .setSuccessUrl("http://localhost:5173/consumer-invoices/" + userId + "?invoiceId=" + invoiceRequest.getInvoiceId() + "&success=true")
                        .setCancelUrl("http://localhost:5173/consumer-invoices/" + userId + "?invoiceId=" + invoiceRequest.getInvoiceId() + "&canceled=true")
